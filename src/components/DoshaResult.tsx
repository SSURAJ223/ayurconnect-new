...
export const DoshaResult: React.FC<DoshaResultProps> = ({ result, cart, onAddToCart, onTalkToDoctorClick }) => {
  return (
    <div className="bg-gradient-to-br from-emerald-50 to-green-50 p-5 sm:p-6 rounded-2xl border border-green-200 animate-fade-in space-y-8">
      <div>
      ...
      {result.sources && result.sources.length > 0 && (
         <div className="pt-4 border-t border-green-200/80">
